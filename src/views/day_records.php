    ...
    <div class="card">
        <div class="card-header">
            <h3><?php                     
                    ...
                    /*$today = strftime('%A, %d de %B de %Y', strtotime('today'));
        ...
        <div class="card-body">
            <div class="d-flex m-5 justify-content-around">
                <?php 
                   /* if(!isset($workingHours->time1)){
                        $workingHours->time1 = null;
                    }
                    if(!isset($workingHours->time2)){
                        $workingHours->time2 = null;
                    }
                    if(!isset($workingHours->time3)){
                        $workingHours->time3 = null;
                    }
                    if(!isset($workingHours->time4)){
                        $workingHours->time4 = null;
                    }*/
                ?>
